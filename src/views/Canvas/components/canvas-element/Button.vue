<!-- ? 画布按钮元素 -->
<template>
    <button ref="buttonEl" :class="classes" :id="data.id" :data-canvas-id="data.id" :type="data.buttonType" :disabled="data.disabled" @click.stop="handleClick">{{ data.text }}</button>
</template>
