<!-- ? 表格标题元素 -->
<template>
  <caption ref="captionEl" :class="data.classes" :id="data.id" :data-canvas-id="data.id" :style="style" @click.stop="handleSelect">
...
import { ref } from 'vue';
import { CanvasTableCaptionElement } from '../../types';
